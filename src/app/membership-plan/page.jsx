...
const MembershipPlanPage = () => {
  ...
  return (
    <div className={styles.pageContainer}>
      <div
        style={{ maxWidth: "1440px", margin: "0 auto", paddingBottom: "20px" }}
      >
      ...
      <div className={styles.headerContainer}>
        <div className={styles.headerLeft}>
          ...
          <p>
            Choose the perfect plan to list your properties and grow your
            business.
          </p>
        </div>
        <div className={styles.headerRight}>
          <div className={styles.headerTrustItem}>
            <div className={styles.headerTrustIcon}>
              <FaShieldAlt />
            </div>
        ...
        {loading
          ...
          : plans
              ...
              .map((plan) => (
                <div
                  key={plan.id}
                  className={`${styles.planCard} ${plan.is_popular ? styles.popularCard : ""}`}
                >
                  {plan.is_popular && (
                  ...
                  <p className={styles.planDesc}>
                    {plan.short_description ||
                      `Great for starting out and testing the waters.`}
                  </p>
                  ...
                  <ul className={styles.featuresList}>
                    {plan.features
                      ?.slice(
                        0,
                        expandedPlans[plan.id] ? plan.features.length : 8,
                      )
                      .map((feature, idx) => renderFeature(feature, idx))}
                  </ul>
                  ...
                  <Link
                    href={`/membership-plan/checkout/${encodeId(plan.id)}`}
                    className={`${styles.buyBtn} ${plan.is_popular ? styles.primaryBtn : styles.secondaryBtn}`}
                  >
                    Choose Plan
                  </Link>
                </div>
