...
const AgentProfileLayout = () => {
  return (
    ...
    <div className={` ${styles.profileContainer} container `}>
        ...
        <div className={` ${styles.col} col-8 `}><AgentProfileDetails/> </div>
        <div className={` ${styles.col} col-4 `}> <AgentForm/> </div>
        </div>
    </div>
...
<div className={styles.AboutAgentsection}>
    ...
    <div className={` ${styles.Container} container `}>
        ...
        <div className={` ${styles.col} col-8 `}><AgentPropertyList/> </div>
        <div className={` ${styles.col} col-4 `}> <AgentReviews/> </div>
        </div>
    </div>
   ...
   <div className={styles.header}>
    <div className={` ${styles.headercontainer} container `}>
      ...
      <p>Toll Free Number: 274-5607-0011</p>
        ...
        <div className={` ${styles.Container} container `}>
        <div className={` ${styles.enquirycontainer} row `}>
        <div className={` ${styles.col} col-6 `}><ContactInfo/> </div>
